  ...
  return (
    <div className="min-h-screen bg-custom-purple w-full overflow-x-hidden">
      ...
      <div>
        <div className="text-center">
          <div className="relative my-20">
            <button
              ...
              className="relative bg-white inline-block text-custom-purple text-2xl sm:text-3xl px-8 sm:px-12 py-2 sm:py-3
             tracking-[0.3rem] sm:tracking-[0.6rem] rounded-lg
             transition duration-300 ease-in-out
             hover:scale-105"
            >
              新着の要約を見る
              {showNew && (
                <span className="absolute flex items-center justify-center pl-0.5 text-sm sm:text-lg w-10 sm:w-15 h-10 sm:h-15
                 -top-4 sm:-top-8 -left-4 sm:-left-7
                 bg-[#C5B4E3] text-white rounded-full font-sans
        ...
        <h2 className="text-white text-lg font-semibold mb-2 pl-4">
          Google検索
        </h2>
